    ...
    return (
        <>
            ...
            <div className='bg-white'>
                <div className='flex justify-between container mx-auto lg:px-[50px] px-4    items-center'>
                            ...
                            >
                                ...
                                <div className='flex  gap-6 my-4'>
                                    ...
                                    <ActiveLink className='hover-effect' to='/logIn'>
                                        <h1 className=' hover-effect font-bold'>Log in</h1>
                                    </ActiveLink>
                                </div>
                    ...
                    <Link to="/"><img className='w-[100px] h-[100px] pb-2 hidden md:block' src={logo} alt="" /></Link>

                    <div className='flex justify-around gap-6 lg:py-0 py-3 items-center'>
                        ...
                        <button className='btn btn-primary   text-white '>Post Your ad</button>
